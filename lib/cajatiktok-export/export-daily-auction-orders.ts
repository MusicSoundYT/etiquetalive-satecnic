...
function getMadridUtcOffsetMinutes(instant: Date): number {
...
function madridDayRangeUtc(dateMadrid: string): { startUtc: string; endUtc: string } {
...
function yesterdayMadridDate(): string {
  const now = new Date();
